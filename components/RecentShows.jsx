...
import KnockDownCentre from '../public/knockdowncentre.png';
...
function RecentShows() {
	const recentShows = [
		...
		{
			name: 'Knockdown Centre',
			image: KnockDownCentre,
		},
		{
			name: 'Gray Area',
			image: GrayArea,
	...
	return (
		<div className="px-10 md:px-20 pt-40">
			<div className="flex justify-between ">
				<h1 className="clashSemiBold text-white text-[3rem] font-semibold">RECENT SHOWS</h1>
